...
func (r *UserRepository) GetUserByEmail(email string) (*models.User, error) {
	query := `SELECT u.id, u.email, u.name, u.avatar_url, u.plan, u.status, u.email_verified, u.api_quota_used, u.api_quota_limit, u.created_at, u.updated_at, u.deleted_at FROM users u WHERE u.email = $1 AND u.deleted_at IS NULL LIMIT 1`

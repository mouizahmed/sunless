    ...
    <div className="flex w-full items-center gap-2 rounded-lg bg-black/40 px-2.5 py-2 backdrop-blur-xl">
      ...
      <div className="flex-1">
        <Input
          ...
          className="h-8 border-white/20 bg-white/10 px-3 py-0 text-sm text-white placeholder:text-white/50 focus-visible:border-white/30 focus-visible:ring-1 focus-visible:ring-white/20"
        />
      </div>

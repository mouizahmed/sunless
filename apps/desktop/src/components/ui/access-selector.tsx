...
const FOLDER_ACCESS_MODES: AccessOption[] = [
  {
    value: "workspace",
    label: "Everyone in workspace",
    description: "All workspace members can access this folder.",
  },
  {
    value: "invite_only",
    label: "Invite only",
...
export function AccessSelector({
  ...
  return (
    <Select value={value} onValueChange={onChange} disabled={disabled}>
      <SelectTrigger className="bg-neutral-50 dark:bg-neutral-800 border-neutral-300 dark:border-neutral-600 cursor-pointer">
